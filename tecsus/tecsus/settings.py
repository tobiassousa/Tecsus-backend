"""
Django settings for tecsus project.
...
SECRET_KEY = 'django-insecure-f-1%zc&19ii()d(ox!(+*re1(8tqi6g411df9km5mh6=8g^4_q'
...
ROOT_URLCONF = 'tecsus.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'tecsus/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'tecsus.wsgi.application'
