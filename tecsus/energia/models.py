...
class FatoContratoEnergia(models.Model):
    ...
    demanda_pt = models.models.CharField(max_length=255, null=True)
    demanda_fp_cap = models.models.CharField(max_length=255, null=True)
    demanda_fp_ind = models.models.CharField(max_length=255, null=True)
