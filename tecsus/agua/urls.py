...
from agua.views import InserirDadosAPIView, FornecedorAguaAPIView, EnderecoAPIView, ClienteContratoAPIView, FatoContratoAguaAPIView, AllDataAPIView, CompareMesAtualComTresUltimosMeses
